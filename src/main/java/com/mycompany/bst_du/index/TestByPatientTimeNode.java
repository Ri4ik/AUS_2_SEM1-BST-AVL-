...
public final class TestByPatientTimeNode extends EntityNode<TestByPatientTimeNode> {
    ...
    public TestByPatientTimeNode(String pid, long ts, long code, PcrTest ref){
        this.patientId=pid; this.ts=ts; this.code=code; this.ref=ref;
    }
    @Override public int compareTo(TestByPatientTimeNode o){
    ...
    @Override public String pretty(){ return "PTime{" + patientId + "," + ts + "," + code + "}"; }
}