/*
 * SK: Uzol indexu pre PCR testy zoradené podľa pracoviska (workstation) a dátumu.
 */
...
public final class TestByWorkstationDateNode extends EntityNode<TestByWorkstationDateNode> {
    ...
    @Override
    public int compareTo(TestByWorkstationDateNode o) {
    ...
    public String pretty() {
        return "WSDate{" + workstationId + "," + ymd + "," + code + "}";
    }
}
