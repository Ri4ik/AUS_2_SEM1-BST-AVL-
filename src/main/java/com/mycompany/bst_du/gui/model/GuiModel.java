...
/** SK: Tenký adaptér nad PcrSystem pre GUI (bez vlastnej biznis logiky). */
public final class GuiModel {
    ...
    /** SK: Auto-kód generuje systém (op1_insertTestRandom). */
    ...
    /** SK: Na potreby GUI/dema (generovanie testov, výbery ap.). */
    public List<String> getAllPatientIds() { return sys.getAllPatientIds(); }
